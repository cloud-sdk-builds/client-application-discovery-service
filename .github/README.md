...
[`@aws-sdk/client-application-discovery-service`](https://www.npmjs.com/package/@aws-sdk/client-application-discovery-service/v/3.1045.0).
...
- @aws-sdk/client-application-discovery-service v3.1045.0 - [https://cloud-sdk-builds.github.io/?sdk=client-application-discovery-service&version=3.1045.0](https://cloud-sdk-builds.github.io/?sdk=client-application-discovery-service&version=3.1045.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service@3.1045.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q3e7wCKRsRmgWr1UWbEe7clLf0VNH44aXg2bQvuvEeW02vvV0rsDhr1h65feTuRq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-application-discovery-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service@3.1045.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service@3.1045.0/index.min.mjs": "sha384-Q3e7wCKRsRmgWr1UWbEe7clLf0VNH44aXg2bQvuvEeW02vvV0rsDhr1h65feTuRq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-application-discovery-service/blob/refs/tags/3.1045.0/LICENSE
```
