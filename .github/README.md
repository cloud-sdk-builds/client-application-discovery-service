...
[`@aws-sdk/client-application-discovery-service`](https://www.npmjs.com/package/@aws-sdk/client-application-discovery-service/v/3.922.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service@3.922.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9YM3Anc+s1M9KsGzzH+LaHqQBq04waWa4BRJVV5f6uOtC94LlGT4PVVk52+D/7sr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-application-discovery-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service@3.922.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service@3.922.0/index.min.mjs": "sha384-9YM3Anc+s1M9KsGzzH+LaHqQBq04waWa4BRJVV5f6uOtC94LlGT4PVVk52+D/7sr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-application-discovery-service/blob/refs/tags/3.922.0/LICENSE
```
