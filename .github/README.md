...
[`@aws-sdk/client-application-discovery-service`](https://www.npmjs.com/package/@aws-sdk/client-application-discovery-service/v/3.1091.0).
...
- @aws-sdk/client-application-discovery-service - [https://cloud-sdk-builds.github.io/?sdk=client-application-discovery-service](https://cloud-sdk-builds.github.io/?sdk=client-application-discovery-service)
- @aws-sdk/client-application-discovery-service v3.1091.0 - [https://cloud-sdk-builds.github.io/?sdk=client-application-discovery-service&version=3.1091.0](https://cloud-sdk-builds.github.io/?sdk=client-application-discovery-service&version=3.1091.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service@3.1091.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fJlzhleKBbXKZjGZhhBwzDS6JUACt1+G3QVogdia7t00hYdxKsnTGL6f4VBp5xeR
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-application-discovery-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service@3.1091.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service@3.1091.0/index.min.mjs": "sha384-fJlzhleKBbXKZjGZhhBwzDS6JUACt1+G3QVogdia7t00hYdxKsnTGL6f4VBp5xeR"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-application-discovery-service";
...
```
https://github.com/cloud-sdk-builds/client-application-discovery-service/blob/refs/tags/3.1091.0/LICENSE
```
