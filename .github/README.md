...
[`@aws-sdk/client-application-discovery-service`](https://www.npmjs.com/package/@aws-sdk/client-application-discovery-service/v/3.1138.0).
...
- @aws-sdk/client-application-discovery-service v3.1138.0 - [https://cloud-sdk-builds.github.io/?sdk=client-application-discovery-service&version=3.1138.0](https://cloud-sdk-builds.github.io/?sdk=client-application-discovery-service&version=3.1138.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service@3.1138.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rg2/ELmXI1nXPRgp+CJfwzaDeK66K4/HRIq48ypypiJY71MBZoMhc6zZjtwk7za4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-application-discovery-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service@3.1138.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-discovery-service@3.1138.0/index.min.mjs": "sha384-rg2/ELmXI1nXPRgp+CJfwzaDeK66K4/HRIq48ypypiJY71MBZoMhc6zZjtwk7za4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-application-discovery-service/blob/refs/tags/3.1138.0/LICENSE
```
